...
class _AdminDashboardScreenState extends State<AdminDashboardScreen> {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          Text(
            'Tổng quan ${selectedTime.toLowerCase()}: $selectedCategory',
  ...
  Widget _getBottomTitles(double value, TitleMeta meta) {
    List<String> titles;
    if (selectedTime == 'Ngày') {
      titles = ['0h', '6h', '12h', '18h', '24h'];
    } else if (selectedTime == 'Tuần')
      titles = ['T2', 'T3', 'T4', 'T5', 'T6', 'T7', 'CN'];
    else if (selectedTime == 'Tháng')
      titles = ['W1', 'W2', 'W3', 'W4'];
    else
      titles = ['Q1', 'Q2', 'Q3', 'Q4'];
    return Text(
  ...
  List<BarChartGroupData> _generateBarGroups() {
    List<double> values = (selectedTime == 'Tuần')
        ? [40, 70, 50, 85, 60, 30, 45]
        : [20, 50, 40, 90];
  ...
  Widget _buildDynamicServiceList() {
    if (selectedCategory == 'Tất cả') {
      ...
      return Column(
        ...
        children: [
          Text(
            'Chi tiết dịch vụ: $selectedCategory',
            style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold),
          ),
          const SizedBox(height: 16),
          Container(
