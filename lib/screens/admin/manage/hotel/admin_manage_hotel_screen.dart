...
class _AdminManageHotelScreenState extends State<AdminManageHotelScreen> {
  ...
  final List<Map<String, dynamic>> _mockRooms = [
    {
      ...
      "price": 400000,
      "description": "Phòng giường đôi có cửa sổ.",
      "requirements": "Không hút thuốc",
      "services": "Wifi, Nước suối",
      "image": "",
      "status": "Trống",
      "isFirebase": false,
    },
    {
      ...
      "requirements": "Không mang thú cưng",
      "services": "Wifi, Ăn sáng, Massage",
      "image": "",
      "status": "Đã thuê",
      "isFirebase": false,
    },
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          int standardCount = combined
              .where((r) => r['category'] == 'Phòng Tiêu chuẩn')
              .length;
          int vipCount = combined
              .where((r) => r['category'] == 'Phòng VIP')
              .length;
          int luxuryCount = combined
              .where((r) => r['category'] == 'Phòng Cao cấp')
              .length;
          int availableCount = combined
                        ...
                        child: ListTile(
                          ...
                          subtitle: Column(
                            ...
                            children: [
                              ...
                              Text(
                                "${item['category']} • ${formatCurrency(item['price'])}đ",
                              ),
  ...
  void _showRoomForm({Map<String, dynamic>? item}) {
    ...
    final priceCtrl = TextEditingController(
      text: item != null ? formatCurrency(item['price']) : '',
    );
            ...
            child: Column(
              ...
              children: [
                      ...
                      .map(
                        (s) => DropdownMenuItem(
                          ...
                          child: Text(
                            s,
                            style: TextStyle(
                              color: s == 'Trống' ? Colors.green : Colors.red,
                              fontWeight: FontWeight.bold,
                            ),
                          ),
                        ),
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(
                    labelText: 'Dịch vụ kèm (VD: Ăn sáng, Massage)',
                    border: OutlineInputBorder(),
                  ),
                ),
                const SizedBox(height: 10),
                ...
                TextField(
                  controller: reqCtrl,
                  decoration: const InputDecoration(
                    labelText: 'Yêu cầu (VD: Không hút thuốc)',
                    border: OutlineInputBorder(),
                  ),
                ),
              ],
                  ...
                  : () async {
                      ...
                      if (roomNo.isEmpty) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('Vui lòng nhập Số phòng!'),
                      ...
                      String rawPrice = priceCtrl.text.replaceAll(
                        RegExp(r'[^0-9]'),
                        '',
                      );
                      ...
                      final data = {
                        'roomNumber': roomNo,
                        'price': finalPrice, // Dùng số đã được lọc sạch
                      ...
                      try {
                        if (item != null) {
                          if (item['isFirebase'] == true) {
                            ...
                            setState(() {
                              final index = _mockRooms.indexWhere(
                                (r) => r['id'] == item['id'],
                              );
                              if (index != -1) {
                                _mockRooms[index] = {
