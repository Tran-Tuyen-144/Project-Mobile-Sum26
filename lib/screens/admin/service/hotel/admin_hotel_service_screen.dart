...
class AdminHotelServiceScreen extends StatefulWidget {
  ...
  @override
  State<AdminHotelServiceScreen> createState() =>
      _AdminHotelServiceScreenState();
}
              ...
              builder: (context, snapshot) {
                ...
                if (rooms.isEmpty) {
                  return const Padding(
                    ...
                    child: Text(
                      "Không có phòng trống cho hạng này.",
                      style: TextStyle(
                        color: Colors.red,
                ...
                return Column(
                  children: rooms
                      .map(
                        (room) => Card(
                          color: _selectedRoom?.id == room.id
                          ...
                          child: ListTile(
                            ...
                            trailing: _selectedRoom?.id == room.id
                                ? const Icon(
                                    Icons.check_circle,
      ...
      bottomNavigationBar: Container(
        ...
        child: SafeArea(
          child: ElevatedButton(
            onPressed:
                (_selectedRoom == null || _checkIn == null || _checkOut == null)
                ? null
                : () => _navigateToCheckout(),
            child: const Text(
              "Thanh toán",
