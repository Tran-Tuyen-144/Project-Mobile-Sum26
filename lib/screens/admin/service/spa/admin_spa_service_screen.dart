                ...
                return DropdownButtonFormField<String>(
                  ...
                  onChanged: (val) {
                    setState(() {
                      ...
                      _selectedServiceData = combinedServices.firstWhere(
                        (e) => e.id == val,
                      );
                    });
                  },
  ...
  void _navigateToCheckout() async {
    if (_nameCtrl.text.isEmpty || _selectedServiceData == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Vui lòng nhập tên và chọn dịch vụ!'),
    ...
    if (result == true) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Đặt lịch Spa thành công!'),
