...
class _AdminPetListScreenState extends State<AdminPetListScreen> {
  ...
  void _showDeleteDialog(int index) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text('Bạn có chắc chắn muốn xóa bé "${_pets[index]['name']}" khỏi hệ thống không?'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Hồ sơ thú cưng", style: TextStyle(color: Colors.black87, fontWeight: FontWeight.bold, fontSize: 18)),
        backgroundColor: Colors.white,
        elevation: 0,
      ...
      body: _pets.isEmpty
          ? const Center(child: Text("Chưa có thú cưng nào", style: TextStyle(color: AppColors.textSoft)))
          : ListView.builder(
          ...
          return Container(
            ...
            child: ListTile(
              ...
              leading: CircleAvatar(
                ...
                backgroundImage: pet["image"].toString().startsWith('assets/')
              ...
              subtitle: Text(pet["age"], style: const TextStyle(color: Colors.black54)),
